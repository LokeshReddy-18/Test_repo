...
LANGUAGES = {
    ...
    '.jsx': Language('build/my-languages.so', 'javascript'),
    '.cjs': Language('build/my-languages.so', 'javascript'),
    '.ts': Language('build/my-languages.so', 'typescript'),
    '.java': Language('build/my-languages.so', 'java'),
    '.cpp': Language('build/my-languages.so', 'cpp'),
    '.c': Language('build/my-languages.so', 'c'),
    '.cs': Language('build/my-languages.so', 'c_sharp'),
